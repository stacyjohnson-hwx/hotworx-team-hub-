...
const TEMPLATE_DEFAULTS = [
  { template_key: 'day0_orientation',     label: 'Day 0 — New member orientation', channel: 'in_studio', body: "**New Member Orientation — do this in studio with {first_name}:**\n- Give a full studio tour — saunas, FX Zone, water, restrooms.\n- Walk through the HOTWORX app: booking, canceling, the workout menu.\n- Show how a session works — start the sauna, use the tablet.\n- Set up Brivo door access.\n- Answer questions and help them book their first 3 sessions." },
